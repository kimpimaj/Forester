namespace Forester.Framework.EventStore
{
    public class VersionVector
    {
        ...
        {
            get => _value.ContainsKey(key) ? _value[key] : 0;
        }
        ...
        /// <summary>
        /// Updates value for a node
        /// </summary>
        /// <param name="node">Node to be updated</param>
        /// <returns>VersionVector with updated value</returns>
        ...
        /// </summary>
        /// <param name="another">Comparison target</param>
        ...
        /// <summary>
        /// Does cell wise maximum of two version vectors.
        /// Used for synchronizing versions.
        /// </summary>
        /// <param name="another"></param>
        /// <returns>Synchronized version</returns>
        ...
        /// <summary>
        /// Does cell wise minimum of two version vectors.
        /// Used for calculating stable version.
        /// </summary>
        /// <param name="another"></param>
        /// <returns>Stable version</returns>
